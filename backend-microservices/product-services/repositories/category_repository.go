...
type CategoryRepository interface {
	...
	AddProductCategory(ctx context.Context, productID uint, categoryIDs []int) ([]dto.CategoryResponseDTO, error)
...
func (r *categoryRepository) AddProductCategory(ctx context.Context, productID uint, categoryIDs []int) ([]dto.CategoryResponseDTO, error) {
