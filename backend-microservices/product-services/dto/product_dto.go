...
type CreateProductRequestDTO struct {
	...
	Category    []int                   `form:"category" validate:"required" binding:"required"`
...
type UpdateProductRequestDTO struct {
	...
	CategoryID  []uint  `json:"category_id" validate:"required" binding:"required"`
	Price       float32 `json:"price" validate:"required" binding:"required"`
	OldPrice    float32 `json:"old_price"`
	Stock       int     `json:"stock" validate:"required" binding:"required"`
	IsNew       bool    `json:"is_new"`
}
