...
type UserService interface {
	GetAllUser(ctx context.Context) ([]dto.UserResponseDTO, error)
...
func (s *userService) GetAllUser(ctx context.Context) ([]dto.UserResponseDTO, error) {
...
func (s *userService) DeleteUser(ctx context.Context, user dto.UserDeleteDTO) error {
