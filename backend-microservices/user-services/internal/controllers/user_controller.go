...
func (c *UserController) RegisterUser(ctx context.Context, req *pb.UserCreateRequest) (*pb.UserResponse, error) {
	...
	return &pb.UserResponse{
		...
		MemberSince: timestamppb.New(createdUser.MemberSince),
	}, nil
}
...
func (c *UserController) GetUserByUsername(ctx context.Context, req *pb.GetUserByUsernameRequest) (*pb.UserResponse, error) {
	...
	if err != nil {
		return nil, status.Errorf(codes.NotFound, constants.ErrUserServiceGet, err)
	}
	...
	return &pb.UserResponse{
		...
		Role:        user.Role,
		MemberSince: timestamppb.New(user.MemberSince),
	}, nil
}
...
func (c *UserController) GetAllUsers(ctx context.Context, _ *pb.Empty) (*pb.UserList, error) {
	...
	if err != nil {
		return nil, status.Errorf(codes.NotFound, constants.ErrUserServiceGetAll, err)
	}
...
func (c *UserController) UpdateUser(ctx context.Context, req *pb.UserUpdateRequest) (*pb.UserResponse, error) {
	...
	if err != nil {
		return nil, status.Errorf(codes.Internal, constants.ErrUserServiceUpdate, err)
	}
...
func (c *UserController) DeleteUser(ctx context.Context, req *pb.UserDeleteRequest) (*pb.Empty, error) {
	...
	if err != nil {
		return nil, status.Errorf(codes.Internal, constants.ErrUserServiceDelete, err)
	}
	return &pb.Empty{}, nil
}
