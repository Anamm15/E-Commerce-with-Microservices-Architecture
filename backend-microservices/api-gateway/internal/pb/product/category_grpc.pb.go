...
const (
	CategoryService_GetAllCategories_FullMethodName = "/product.CategoryService/GetAllCategories"
...
func (c *categoryServiceClient) GetAllCategories(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryListResponse, error) {
...
func (UnimplementedCategoryServiceServer) GetAllCategories(context.Context, *emptypb.Empty) (*CategoryListResponse, error) {
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/product/category.proto",
}
