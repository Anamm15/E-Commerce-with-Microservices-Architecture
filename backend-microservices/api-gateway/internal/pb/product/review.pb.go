...
// 	protoc        v6.33.0
// source: proto/product/review.proto
...
func (x *UserReview) Reset() {
	*x = UserReview{}
	mi := &file_proto_product_review_proto_msgTypes[0]
...
func (x *Review) Reset() {
	*x = Review{}
	mi := &file_proto_product_review_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Review) GetUser() *UserReview {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *CreateReviewRequest) Reset() {
	*x = CreateReviewRequest{}
	mi := &file_proto_product_review_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UpdateReviewRequest) Reset() {
	*x = UpdateReviewRequest{}
	mi := &file_proto_product_review_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GetReviewByProductRequest) Reset() {
	*x = GetReviewByProductRequest{}
	mi := &file_proto_product_review_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DeleteReviewRequest) Reset() {
	*x = DeleteReviewRequest{}
	mi := &file_proto_product_review_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ReviewListResponse) Reset() {
	*x = ReviewListResponse{}
	mi := &file_proto_product_review_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReviewListResponse) Descriptor() ([]byte, []int) {
	return file_proto_product_review_proto_rawDescGZIP(), []int{6}
}
...
func (x *ReviewResponse) Reset() {
	*x = ReviewResponse{}
	mi := &file_proto_product_review_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReviewResponse) Descriptor() ([]byte, []int) {
	return file_proto_product_review_proto_rawDescGZIP(), []int{7}
}
...
var File_proto_product_review_proto protoreflect.FileDescriptor

const file_proto_product_review_proto_rawDesc = "" +
	"\n" +
	...
	"\x06review\x18\x01 \x01(\v2\x0f.product.ReviewR\x06review2\xfe\x02\n" +
	"\rReviewService\x12D\n" +
	"\rGetAllReviews\x12\x16.google.protobuf.Empty\x1a\x1b.product.ReviewListResponse\x12S\n" +
	"\x14GetReviewByProductID\x12\".product.GetReviewByProductRequest\x1a\x17.product.ReviewResponse\x12E\n" +
	...
	"\fDeleteReview\x12\x1c.product.DeleteReviewRequest\x1a\x16.google.protobuf.EmptyB Z\x1e/internal/pb/product;productpbb\x06proto3"

var (
	file_proto_product_review_proto_rawDescOnce sync.Once
	file_proto_product_review_proto_rawDescData []byte
)

func file_proto_product_review_proto_rawDescGZIP() []byte {
	file_proto_product_review_proto_rawDescOnce.Do(func() {
		file_proto_product_review_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_product_review_proto_rawDesc), len(file_proto_product_review_proto_rawDesc)))
	})
	return file_proto_product_review_proto_rawDescData
}

var file_proto_product_review_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_proto_product_review_proto_goTypes = []any{
	(*UserReview)(nil),                // 0: product.UserReview
	(*Review)(nil),                    // 1: product.Review
	(*CreateReviewRequest)(nil),       // 2: product.CreateReviewRequest
	(*UpdateReviewRequest)(nil),       // 3: product.UpdateReviewRequest
	(*GetReviewByProductRequest)(nil), // 4: product.GetReviewByProductRequest
	(*DeleteReviewRequest)(nil),       // 5: product.DeleteReviewRequest
	(*ReviewListResponse)(nil),        // 6: product.ReviewListResponse
	(*ReviewResponse)(nil),            // 7: product.ReviewResponse
	(*timestamppb.Timestamp)(nil),     // 8: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),             // 9: google.protobuf.Empty
}
var file_proto_product_review_proto_depIdxs = []int32{
	8, // 0: product.Review.date:type_name -> google.protobuf.Timestamp
	0, // 1: product.Review.user:type_name -> product.UserReview
	1, // 2: product.ReviewListResponse.reviews:type_name -> product.Review
	1, // 3: product.ReviewResponse.review:type_name -> product.Review
	9, // 4: product.ReviewService.GetAllReviews:input_type -> google.protobuf.Empty
	4, // 5: product.ReviewService.GetReviewByProductID:input_type -> product.GetReviewByProductRequest
	2, // 6: product.ReviewService.CreateReview:input_type -> product.CreateReviewRequest
	3, // 7: product.ReviewService.UpdateReview:input_type -> product.UpdateReviewRequest
	5, // 8: product.ReviewService.DeleteReview:input_type -> product.DeleteReviewRequest
	6, // 9: product.ReviewService.GetAllReviews:output_type -> product.ReviewListResponse
	7, // 10: product.ReviewService.GetReviewByProductID:output_type -> product.ReviewResponse
	7, // 11: product.ReviewService.CreateReview:output_type -> product.ReviewResponse
	7, // 12: product.ReviewService.UpdateReview:output_type -> product.ReviewResponse
	9, // 13: product.ReviewService.DeleteReview:output_type -> google.protobuf.Empty
...
func init() { file_proto_product_review_proto_init() }
func file_proto_product_review_proto_init() {
	if File_proto_product_review_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_product_review_proto_rawDesc), len(file_proto_product_review_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_product_review_proto_goTypes,
		DependencyIndexes: file_proto_product_review_proto_depIdxs,
		MessageInfos:      file_proto_product_review_proto_msgTypes,
	}.Build()
	File_proto_product_review_proto = out.File
	file_proto_product_review_proto_goTypes = nil
	file_proto_product_review_proto_depIdxs = nil
}
