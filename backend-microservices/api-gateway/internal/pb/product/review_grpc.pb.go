...
const (
	ReviewService_GetAllReviews_FullMethodName        = "/product.ReviewService/GetAllReviews"
	ReviewService_GetReviewByProductID_FullMethodName = "/product.ReviewService/GetReviewByProductID"
	ReviewService_CreateReview_FullMethodName         = "/product.ReviewService/CreateReview"
	ReviewService_UpdateReview_FullMethodName         = "/product.ReviewService/UpdateReview"
	ReviewService_DeleteReview_FullMethodName         = "/product.ReviewService/DeleteReview"
)
...
type ReviewServiceClient interface {
	GetAllReviews(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReviewListResponse, error)
	GetReviewByProductID(ctx context.Context, in *GetReviewByProductRequest, opts ...grpc.CallOption) (*ReviewResponse, error)
...
func (c *reviewServiceClient) GetAllReviews(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReviewListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReviewListResponse)
	err := c.cc.Invoke(ctx, ReviewService_GetAllReviews_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewServiceClient) GetReviewByProductID(ctx context.Context, in *GetReviewByProductRequest, opts ...grpc.CallOption) (*ReviewResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReviewResponse)
	err := c.cc.Invoke(ctx, ReviewService_GetReviewByProductID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReviewServiceServer interface {
	GetAllReviews(context.Context, *emptypb.Empty) (*ReviewListResponse, error)
	GetReviewByProductID(context.Context, *GetReviewByProductRequest) (*ReviewResponse, error)
...
func (UnimplementedReviewServiceServer) GetAllReviews(context.Context, *emptypb.Empty) (*ReviewListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllReviews not implemented")
}
func (UnimplementedReviewServiceServer) GetReviewByProductID(context.Context, *GetReviewByProductRequest) (*ReviewResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetReviewByProductID not implemented")
}
...
func _ReviewService_GetAllReviews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServiceServer).GetAllReviews(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReviewService_GetAllReviews_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServiceServer).GetAllReviews(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _ReviewService_GetReviewByProductID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetReviewByProductRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServiceServer).GetReviewByProductID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReviewService_GetReviewByProductID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServiceServer).GetReviewByProductID(ctx, req.(*GetReviewByProductRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReviewService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "product.ReviewService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ReviewService_GetReviewByProductID_Handler,
		},
		{
	...
	Metadata: "proto/product/review.proto",
}
