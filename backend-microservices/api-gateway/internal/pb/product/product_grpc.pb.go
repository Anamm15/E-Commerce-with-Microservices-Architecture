...
type ProductServiceClient interface {
	GetAllProducts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ProductListResponse, error)
	GetProductByID(ctx context.Context, in *GetProductByIDRequest, opts ...grpc.CallOption) (*ProductResponse, error)
	GetProductByCategoryID(ctx context.Context, in *GetProductByCategoryRequest, opts ...grpc.CallOption) (*ProductListResponse, error)
...
func (c *productServiceClient) GetAllProducts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ProductListResponse, error) {
...
func (c *productServiceClient) GetProductByCategoryID(ctx context.Context, in *GetProductByCategoryRequest, opts ...grpc.CallOption) (*ProductListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductListResponse)
...
type ProductServiceServer interface {
	GetAllProducts(context.Context, *emptypb.Empty) (*ProductListResponse, error)
	GetProductByID(context.Context, *GetProductByIDRequest) (*ProductResponse, error)
	GetProductByCategoryID(context.Context, *GetProductByCategoryRequest) (*ProductListResponse, error)
...
func (UnimplementedProductServiceServer) GetAllProducts(context.Context, *emptypb.Empty) (*ProductListResponse, error) {
...
func (UnimplementedProductServiceServer) GetProductByCategoryID(context.Context, *GetProductByCategoryRequest) (*ProductListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProductByCategoryID not implemented")
}
...
func _ProductService_GetProductByCategoryID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProductByCategoryID(ctx, req.(*GetProductByCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
