...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\x05Empty\"4\n" +
	"\bUserList\x12(\n" +
	"\x05users\x18\x01 \x03(\v2\x12.user.UserResponseR\x05users\"D\n" +
	...
	"\busername\x18\x01 \x01(\tR\busername2\xec\x02\n" +
	"\vUserService\x12<\n" +
	"\tLoginUser\x12\x16.user.UserLoginRequest\x1a\x17.user.UserLoginResponse\x12;\n" +
	"\fRegisterUser\x12\x17.user.UserCreateRequest\x1a\x12.user.UserResponse\x12G\n" +
...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	10, // 2: user.UserResponse.member_since:type_name -> google.protobuf.Timestamp
	1,  // 3: user.UserList.users:type_name -> user.UserResponse
	7,  // 4: user.UserService.LoginUser:input_type -> user.UserLoginRequest
	2,  // 5: user.UserService.RegisterUser:input_type -> user.UserCreateRequest
	9,  // 6: user.UserService.GetUserByUsername:input_type -> user.GetUserByUsernameRequest
	5,  // 7: user.UserService.GetAllUsers:input_type -> user.Empty
	3,  // 8: user.UserService.UpdateUser:input_type -> user.UserUpdateRequest
	4,  // 9: user.UserService.DeleteUser:input_type -> user.UserDeleteRequest
	8,  // 10: user.UserService.LoginUser:output_type -> user.UserLoginResponse
	1,  // 11: user.UserService.RegisterUser:output_type -> user.UserResponse
	1,  // 12: user.UserService.GetUserByUsername:output_type -> user.UserResponse
	6,  // 13: user.UserService.GetAllUsers:output_type -> user.UserList
	1,  // 14: user.UserService.UpdateUser:output_type -> user.UserResponse
	5,  // 15: user.UserService.DeleteUser:output_type -> user.Empty
